                    ...
                    <div className="legal-tab-content">
                        {activeTab === 'van-ban' && (
                            <div className="legal-documents-list">
                                <div className="legal-doc-item">
                                    <h4>Nghị định số 288/2025/NĐ-CP</h4>
                                    <p>Quy định về quản lý tàu bay không người lái và các phương tiện bay khác, bảo đảm an toàn bầu trời và an ninh quốc gia.</p>
                                    <p className="legal-date">Ngày 05/11/2025</p>
                                    {/* Link ngoài nên dùng thẻ a bình thường */}
                                    <a href="#" className="legal-link">Xem chi tiết →</a>
                                </div>
                                <div className="legal-doc-item">
                                    <h4>Thông tư số 39/2025/TT-BQP</h4>
                                    <p>Danh mục tiêu chuẩn, quy chuẩn kỹ thuật đối với tàu bay không người lái, phương tiện bay khác.</p>
                                    <p className="legal-date">Ngày 05/06/2025</p>
                                    <a href="#" className="legal-link">Xem chi tiết →</a>
                                </div>
                            </div>
                        )}
                        ...
                        {activeTab === 'tham-quyen' && (
                            <div className="authority-content">
                                <div className="authority-item">
                                    <h4>Bộ Quốc phòng</h4>
                                    <p>Quản lý không phận, xác định các khu vực cấm bay và hạn chế bay vì lý do an ninh quốc phòng.</p>
                                </div>
                                <div className="authority-item">
                                    <h4>Bộ Công an</h4>
                                    <p>Đảm bảo an ninh, xử lý các vi phạm liên quan đến hoạt động bay không người lái trái phép.</p>
                                </div>
                            </div>
                        )}
                        ...
                        {activeTab === 'bieu-mau' && (
                            <div className="forms-list">
                                {[
                                    "Mẫu số 01 – Đơn đề nghị nhập khẩu",
                                    "Mẫu số 06 – Đơn đề nghị cấp phép bay",
                                    "Mẫu số 07 – Đơn đề nghị học, cấp Giấy phép",
                                    "Mẫu số 12 – Đơn trình báo mất Giấy phép"
                                ].map((form, idx) => (
                                    <div key={idx} className="form-item">
                                        <h4>{form}</h4>
                                        {/* Nút tải xuống vẫn dùng a href */}
                                        <a href="#" className="form-download">Tải xuống</a>
                                    </div>
                                ))}
                            </div>
                        )}
