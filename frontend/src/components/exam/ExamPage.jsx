              ...
              <div className="card p-6">
                ...
                <div className="flex flex-col gap-2 mb-4">
                  {documentsList.map((doc, idx) => (
                    <div key={idx} className="flex items-center gap-3 p-3 border rounded-lg hover:bg-secondary transition-colors cursor-pointer group">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-medium truncate text-primary group-hover:underline">{doc.name}</p>
